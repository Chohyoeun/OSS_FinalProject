...
<?php
        session_start();
        $_SESSION['room_number'] = '202';
	?>
        <h1>202 Computer Lab</h1><br />
	<img src="https://github.com/Chohyoeun/OSS_FinalProject/blob/master/imgsrc/classroom202.jpg?raw=true" width="1200" style="margin-left: auto; margin-right: auto; margin-top: 30px; display: block;" class=static">
