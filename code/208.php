...
<?php
        session_start();
	$_SESSION['room_number'] = '208';
	?>
        <h1>208 Lecture Room</h1><br />
        <img src="https://github.com/Chohyoeun/OSS_FinalProject/blob/master/imgsrc/classroom208.jpg?raw=true" width="1200" style="margin-left: auto; margin-right: auto; margin-top: 30px; display: block;" class=static">
